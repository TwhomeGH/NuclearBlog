...
export const projectsData: Project[] = [
	{
		id: "replykit",
		title: "ReplyKit",
		description: "用於iPad/iPhone 的直播推流應用",
		image: "",
		category: "mobile",
		techStack: ["Swift", "JavaScript", "Metal"],
		status: "in-progress",
		liveDemo: "https://www.twitch.tv/coffeelatte0709",
		sourceCode: "https://github.com/TwhomeGH/ReplyKit", // 更改为GitHub链接
		visitUrl: "https://github.com/TwhomeGH/ReplyKit", // 添加前往项目链接
		startDate: "2025-11-03",
		//endDate: "2026-06-01",
		featured: true,
		tags: ["Swift", "iOS App", "Open Source"],
	},
	{
		id: "TTWChatMessageServer",
		title: "TTWChatMessageServer",
		description: "用於接收TikTok / Twitch 訊息 處理服務器",
		image: "",
		category: "web",
		techStack: ["Node.js", "JavaScript"],
		status: "in-progress",
		liveDemo: "https://github.com/TwhomeGH/TTWChatMessageServer",
		sourceCode: "https://github.com/TwhomeGH/TTWChatMessageServer",
		visitUrl: "https://github.com/TwhomeGH/TTWChatMessageServer", // 添加前往项目链接
		startDate: "2025-12-21",
		//endDate: "2023-12-01",
		featured: true,
		tags: ["Node.js", "JavaScript", "Twitch", "TikTok"],
	},
	// {
	// 	id: "task-manager-app",
