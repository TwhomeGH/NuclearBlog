...
export const zh_TW: Translation = {
	...
	[Key.animeEmptyLocal]: "請在 @data/anime.ts 檔案中新增番劇資訊",
	[Key.animeConfigBilibili]: "請在 @config.ts 檔案中設定您的 Bilibili vmid",
	[Key.animeConfigBangumi]: "請在 @config.ts 檔案中設定您的 Bangumi userId",
