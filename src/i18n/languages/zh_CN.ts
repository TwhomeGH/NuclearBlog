...
export const zh_CN: Translation = {
	...
	[Key.animeEmptyLocal]: "请在 @data/anime.ts 文件中添加番剧信息",
	[Key.animeConfigBilibili]: "请在 @config.ts 文件中设置您的 Bilibili vmid",
	[Key.animeConfigBangumi]: "请在 @config.ts 文件中设置您的 Bangumi userId",
